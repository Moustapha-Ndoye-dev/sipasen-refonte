...
/**
 * Footer component for the SIPASEN website.
 * Updated with new colors and logo.
 */
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-20 pt-20 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <p className="text-white/50 text-[15px] leading-relaxed max-w-sm font-sans">
                  Leader historique de la transformation du Polystyrène Expansé (PSE) au Sénégal, accompagnant les acteurs de l&apos;agro-industrie et du bâtiment depuis 1991.
                </p>
          ...
          <div className="lg:col-span-3 flex flex-col gap-8">
            <div>
              ...
              <ul className="flex flex-col gap-4">
                {['Accueil', 'Nos Produits', 'À Propos', 'Export'].map((item) => (
                  <li key={item}>
                    <a 
                      href={`#${item.toLowerCase().replace(/ /g, '-')}`} 
                      className="text-[13px] font-bold uppercase tracking-wider text-white/80 hover:text-brand-beige transition-colors duration-200"
                    >
                      {item}
                    </a>
                  </li>
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-semibold text-white/80 leading-relaxed">
                      Km 3,5 Boulevard du Centenaire<br />
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xl font-bold text-white tracking-tight">+221 33 832 31 21</p>
                    <div className="flex items-center gap-2 mt-1">
                      <Mail size={14} className="text-brand-beige" />
                      <span className="text-xs text-white/60">contact@sipasen.sn</span>
                    </div>
                  </div>
                </div>
              </div>
